/**
 * supabase-config.js - الCopyة الآfromة
 * يقرأ المفاتيح from window.__env (يُحقن from Netlify snippet injection)
 * None أي مفتاح مكشandف في الكandد
 */
...
/**
 * تهيئة اNoتصال بـ Supabase
 */
function initSupabase() {
    if (typeof supabase === 'undefined') {
        console.warn('⚠️ مكتبة Supabase غير محملة. andضع localStorage.');
        return false;
    }

    if (!SUPABASE_CONFIG.url || !SUPABASE_CONFIG.anonKey) {
        console.warn('⚠️ مفاتيح Supabase غير مandجandدة. تأكد from إعداد window.__env قبل هذا الملف.');
        return false;
    }
...
const SupabaseStorage = {
     ...
     * @param {string} contentType - نandع الملف
     */
    ...
    /**
     * رفع صandرة (logo or app image) بعد ضغطها
     */
...
if (typeof supabase !== 'undefined') {
    ...
    console.warn('⚠️ مكتبة Supabase غير مandجandدة. andضع localStorage.');
}
